...
- 新增 `runtime_llm_configuration` 和 `admin_operation_audit`，迁移版本为 `20260727_002`；运行时配置保存后立即供后续招聘请求使用。
- API 和 Web 最终镜像构建、隔离配置冒烟测试、Alembic 升级及 15 项 pytest 已通过，尚未替换生产容器。
